...
(async function() {
  ...
  if (!main) return;
  if (window.location.pathname.endsWith('2fa-setup.html') || window.location.pathname.endsWith('change-password.html') || window.location.pathname.endsWith('haushalt-wizard.html')) return;
